...
function download_plugin( $path, $plugin ) {
	echo passthru( "wget {$plugin['repo']} -O {$path}.zip" ) . "\n\n";
	echo passthru( "unzip {$path}" ) . "\n\n";
	echo passthru( "mv " . $path . "-master {$path}" ) . "\n\n";
...
function download_plugins() {
	...
	$dependencies = require dirname( __DIR__ ). '/tests/phpunit/includes/dependencies-array.php';
